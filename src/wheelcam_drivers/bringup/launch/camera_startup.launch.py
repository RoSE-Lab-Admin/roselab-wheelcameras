...
def generate_launch_description():
    ...
    set_trigger_mode = TimerAction(
        ...
        actions=[
            ...
            ExecuteProcess(cmd=['v4l2-ctl', '-d', cam_3_dev, '-c', 'white_balance_automatic=0'], output='screen'),

            ExecuteProcess(cmd=['v4l2-ctl', '-d', cam_0_dev, '-c', 'white_balance_temperature=4500'], output='screen'),
            ...
            ExecuteProcess(cmd=['v4l2-ctl', '-d', cam_0_dev, '-c', 'exposure_time_absolute=333'], output='screen'),
            ExecuteProcess(cmd=['v4l2-ctl', '-d', cam_1_dev, '-c', 'exposure_time_absolute=333'], output='screen'),
            ExecuteProcess(cmd=['v4l2-ctl', '-d', cam_2_dev, '-c', 'exposure_time_absolute=333'], output='screen'),
            ExecuteProcess(cmd=['v4l2-ctl', '-d', cam_3_dev, '-c', 'exposure_time_absolute=333'], output='screen'),
